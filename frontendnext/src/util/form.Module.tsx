//frontendNext/src/app/pages/formPage.tsx
//Archivo para la vista del formulario de creacion/edicion de vehiculos
...
const FormPage = ({ formData, marcas, tiposVehiculo, isEditMode, onSubmit, onChange, onCancel }: FormPageProps) => {
    return (
